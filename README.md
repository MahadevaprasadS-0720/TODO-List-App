...
* **Browser Notifications:** Real-time desktop/browser alerts for due tasks and alarms.
* **Kanban Board View:** Interactive board to manage tasks across different stages.
* **Task Data Export/Import:** Easily export or backup your to-do lists as CSV files.
* **User Settings & Customization:** Dedicated settings modal for personalized control.
